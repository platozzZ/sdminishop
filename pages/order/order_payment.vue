			...
			<div v-if='showPay1'>
				<ul style='background-color: #FFFFFF;margin-bottom: 100upx;'>
					...
					<div v-if="needpay > 0 || frist_show">
						...
						<!-- <li class='p-pay' @tap='chooseWay("wxPay")' v-if="open_wxpay==true">
							<div style="width: 100%;">
								<div class="p-pay_yue" style="position: relative;width: 100%;justify-content: space-between;">
									<div style='display: flex;align-items: center;'>
										<img class='p-pay_img' :src="pay_w" alt="">
						...
						<view class='p-pay' @tap='chooseWay("aliPay")' v-if="open_alipay == true">
							<view class="p-yh-pay">
								<view class="p-pay_yue p-yh-pay-wx-d">
									<view class="p-yh-pay-s">
						...
						<!-- <li class='p-pay' @tap='chooseWay("aliPay")' v-if="open_alipay==true">
							<div style="width: 100%;">
								<div class="p-pay_yue" style="position: relative;width: 100%;justify-content: space-between;">
									<div style='display: flex;align-items: center;'>
										<img class='p-pay_img' :src="pay_z" alt="">
										<div style="margin-left: 30upx;">
											<p style="width: 400upx;">
												支付宝支付
											</p>
