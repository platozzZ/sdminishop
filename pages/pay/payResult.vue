<template>
	<div>
		...
		<div>
			...
			<div class='p-go_shopping p-yh-go_shopping' @tap="_home()">继续购物</div>
			<div v-if='order_id' class='p-go_shopping p-go_order' @tap="_order()">查看订单</div>
		</div>
	</div>
</template>
...
<style scoped>
	...
	.p-go_shopping{
		margin: 72upx 30upx 30upx 30upx;
		height: 90upx;
		text-align: center;
		line-height: 90upx;
		font-size: 30upx;
