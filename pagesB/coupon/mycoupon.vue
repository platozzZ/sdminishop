<template>
	<view class="container">
		...
		<view v-if="loadFlag">
			...
			<view class="p-coupon-none p-flex p-flex-direction p-justify-center p-align-center" v-else>
				<image :src="nobargainImg"></image>
				<view class="">暂无{{active==0?"未使用":active==1?"已使用":"已过期"}}优惠券~</view>
			</view>
