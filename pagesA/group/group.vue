<template>
	<div>
		...
		<view class="twins_box">
			<view class="twins" style="border-top: 0;">
		...
		<toload :load="!load">
			...
			<div v-if='list.length==0 || !list'>
				...
				<view class="p-coupon-none p-flex p-flex-direction p-justify-center p-align-center">
					<image :src="noFind"></image>
					<view class="">暂时还没有拼团活动哦~</view>
